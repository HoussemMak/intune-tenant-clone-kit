...
.PARAMETER EnableConditionalAccess
    (Target only) Also request Policy.ReadWrite.ConditionalAccess. Off by default:
    Conditional Access policies are not cloned unless this switch is set.
...
# Conditional Access write access is opt-in (Target only): CA policies are not cloned unless requested.
